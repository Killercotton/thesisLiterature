\documentclass[a4paper]{include/RaM/RaM-MScReport}
\settitle{literature research: Rich Report Outline}
...
\IfFileExists{tmp/RichReportOutline.rro}{\input{tmp/RichReportOutline.rro}}{\input{RichReportOutline.rro}}
